async function currency() {
    const response = await fetch(`http://apilayer.net/api/live?access_key=45f25aec4f09ef40739039c0f10a1a04&pairs=EURUSD,EURGBP,GBPUSD,USDJPY,AUDUSD,USDCHF,NZDUSD,USDCAD,USDZAR`)
